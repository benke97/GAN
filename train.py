...
for epoch in range(num_epochs):
    ...
    for real_A, real_B in zip(loader_A_train, loader_B_train):
    ...
    print(f"TRAINING: Generator AB Loss: {avg_loss_G_AB:.5f}, Generator BA Loss: {avg_loss_G_BA:.5f}, Discriminator A Loss: {avg_loss_D_A:.5f}, Discriminator B Loss: {avg_loss_D_B:.5f}")
    ...
    with torch.no_grad():
        ...
        for real_A, real_B in zip(loader_A_val, loader_B_val):
        ...
        print(f"VALIDATION: Generator AB Loss: {avg_val_loss_G_AB:.5f}, Generator BA Loss: {avg_val_loss_G_BA:.5f}, Discriminator A Loss: {avg_val_loss_D_A:.5f}, Discriminator B Loss: {avg_val_loss_D_B:.5f}")
